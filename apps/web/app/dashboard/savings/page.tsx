        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="bg-card p-6 rounded-lg border shadow-sm">
                    ...
                    <p className="text-4xl font-bold text-green-600">2.5%</p>
                ...
                <div className="bg-card p-6 rounded-lg border shadow-sm">
                    ...
                    {isLoading ? (
                        ...
                        <p className="text-4xl font-bold text-green-600">+{(totalSavings * 0.025).toFixed(2)} €</p>
                    )}
                </div>
            </div>
                            ...
                            <div key={account.id} className="p-4 rounded-lg border bg-muted/50">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-sm text-green-600">+{(account.balance * 0.025).toFixed(2)} € / an</p>
                                    </div>
                                </div>
